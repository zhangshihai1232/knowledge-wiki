...
```bash
wiki-ops frontmatter get canon/domains/ai/concepts/embedding.md last_updated
wiki-ops frontmatter get-list canon/domains/ai/concepts/embedding.md sources
```
...
```bash
wiki-ops frontmatter set canon/domains/ai/concepts/embedding.md last_updated "2026-04-09"
wiki-ops frontmatter set canon/domains/ai/concepts/embedding.md staleness_days "0"
wiki-ops frontmatter set canon/domains/ai/concepts/embedding.md last_compiled "2026-04-09"
wiki-ops append-log --spec refresh \
  --message "页面: ai/concepts/embedding | staleness_days: 104→0 | 处理: 内容确认 | 维护者: alice"
```

> **LLM 职责**：将维护记录追加到 canon 页 `## 维护记录` 节（内容写入）。
